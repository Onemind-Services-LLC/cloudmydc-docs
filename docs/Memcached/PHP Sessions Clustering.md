...
At the same time, the NGINX load balancer is distributing traffic across the cluster containing HTTP resources. You can [check the load balancing](http://localhost:3000/docs/Load%20Balancers/NGINX/Testing%20Load%20Balancing) in the platform using different load balancing tools.
