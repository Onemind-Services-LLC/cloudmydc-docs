...
The platform command-line interface (**CLI**) is designed to simplify interaction with your Cloud Platform account, allowing you to execute required commands via your local machine’s terminal. It can handle the vast majority of available operations remotely, complementing the wide stack of capabilities provided via the [dashboard](http://localhost:3000/docs/quickstart/dashboard-guide) and [platform API](https://cloudmydc.com/).
...
So, let’s start with the [platform CLI installation](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/platform-cli-overview#cli-installation) and reveal some [key points](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/platform-cli-overview#getting-started) of its usage before proceeding further.

Subsequently, you can dive deeper with the [platform CLI tutorials](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/platform-cli-overview#cli-tutorials) on particular operations.
...
- **_Platform URL_** - PaaS installation URL in the _app.[{hoster_domain}](http://localhost:3000/docs/quickstart/hosters-list-&-info)_ format
...
- [environment creation](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/environment-creation)
- [environment start/stop](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/environment-start-stop)
- [environment cloning](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/environment-cloning)
- [environment migration](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/environment-migration)
- [server scaling](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/server-scaling)
- [container redeploy](/docs/category/container-deployment)
- [container volumes](http://localhost:3000/docs/container/container-configuration/volumes)
- [mount points](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/mount-points)
- [VCS projects deployment](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/vcs-project-deployment)
- [swap Public IPs](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/swap-public-ips)
- [install JPS](http://localhost:3000/docs/deployment-tools/api-&-cli/platform-cli/installing-jps)
