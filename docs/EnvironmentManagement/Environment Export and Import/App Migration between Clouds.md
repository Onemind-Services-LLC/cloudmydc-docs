...
- [export](https://cloudmydc.com/) your environment from PaaS installation it is currently hosted at
- [import](https://cloudmydc.com/) it to the preferred target platform
...
- You can also use the [Environment Transferring](https://cloudmydc.com/) option for moving your projects between different accounts of a single hosting provider platform, without the necessity to export/import them.
