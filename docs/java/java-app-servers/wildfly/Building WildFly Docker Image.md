...
![Locale Dropdown](./img/BuildingWildFlyDockerImage/01-building-wildfly-docker-image.png)
...
- `{image_name}` - image repository appellation; optionally, a version tag could be added after the “:” separator (e.g. _jelastic/wildfly:latest_)
...
![Locale Dropdown](./img/BuildingWildFlyDockerImage/02-add-new-custom-image.png)
...
![Locale Dropdown](./img/BuildingWildFlyDockerImage/03-custom-image-repository.png)
...
![Locale Dropdown](./img/BuildingWildFlyDockerImage/04-create-custom-wildfly-docker-image.png)
...
![Locale Dropdown](./img/BuildingWildFlyDockerImage/05-wildfly-docker-open-in-browser.png)
...
![Locale Dropdown](./img/BuildingWildFlyDockerImage/06-custom-wildfly-docker-home-page.png)
