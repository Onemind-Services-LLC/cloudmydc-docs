...
3. You can ensure your project files are now available. Open the **[Configuration File Manager](https://cloudmydc.com/)** for your environment, go to the **webroot** directory, and check a folder named after the specified context (**ROOT** by default) inside.
