    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#dashboard-performance-optimization">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#ubuntu-22-support">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#api-to-move-public-ips">
                    Learn More >>
                </a>
            </div>
        </div>
    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#platform-optimizations">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#show-logs-button-in-dashboard-notifications">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#api-changes">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#software-stack-versions">
                    Learn More >>
                </a>
            </div>
        </div>
    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#fixes-compatible-with-prior-versions">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#bug-fixes">
                    Learn More >>
                </a>
            </div>
        </div>
...
![Locale Dropdown](./img/ReleaseNotes7.3/01-ubuntu-22-support.png)

</div>

[More info](http://localhost:3000/docs/Container/Container%20Image%20Requirements)
...
The new **_MoveExtIP_** API method allows moving external IP addresses from the source node to the target node. It complements the existing [SwapExtIps](http://localhost:3000/docs/Deployment%20Tools/API%20&%20CLI/Platform%20CLI/Swap%20Public%20IPs) API, making the management of existing public IPs more flexible. Additionally, the new method supports nodes with multiple IPs and can manage them in a single API call.
...
Below, you can find a list of all changes to the public API in the 7.3 platform version (compared to the preceding [7.1](http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.1#api-changes) ones):

- Implemented a new **_MoveExtIP_** API method (the **binder** service) that can [move external IP addresses](http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#api-to-move-public-ips) between containers and can operate with multiple IPs
- Added a new **_GetBasicEnvsInfo_** API method (the **control** service) to improve the [dashboard loading speed](http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.3#platform-optimizations)
