    ...
    <div>
        <div style={{
            ...
            <h3 style={{
                fontSize: '23px',
                fontWeight: '500',
        }}>Beta Label Removal for MongoDB/PostgreSQL Auto-Clustering</h3>
            <p>Removed the beta label for the MongoDB and PostgreSQL auto-clustering</p>
            <div style={{
            display: 'flex',
...
![Locale Dropdown](./img/ReleaseNotes6.0.5/01-mongodb-auto-clustering.png)
