...
Starting with the current 8.2.4 PaaS release, the alternative OS template for the discontinued CentOS Linux 8 stable release was changed to ***AlmaLinux 8***. [AlmaLinux](1) is an open-source 1:1 binary-compatible clone of RHEL that is guided and built by the community.

:::danger

Note: Virtuozzo Application Platform no longer supports the previously used *CentOS Stream 8* operating system template.
