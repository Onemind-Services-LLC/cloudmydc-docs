...
In the current 7.3.2 release, the platform **[SSH Gate](1)** components were updated to support new public key algorithms and the latest SSH versions. The list of changes includes the following improvements:
