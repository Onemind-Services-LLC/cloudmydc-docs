...
<div style={{
    ...
    <a href="/docs/PlatformOverview/Release%20Notes/Release%20Notes%208.2">
        Back to the top
    </a>
</div>
...
Below, you can find a list of all changes to the public API in the 8.2.2 platform version (compared to the preceding [8.0.2](/docs/PlatformOverview/Release%20Notes/Release%20Notes%208.2#api-changes) ones):
...
[More info](/docs/Deployment%20Tools/API%20&%20CLI/API%20Methods)
