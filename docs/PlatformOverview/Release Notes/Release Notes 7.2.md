    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.2#platform-rebranding">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.2#centos-stream-8-os-support">
                    Learn More >>
                </a>
            </div>
        </div>
    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.2#collaboration-policy-for-custom-commands">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.2#environment-selection-field-adjustment">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.2#software-stack-versions">
                    Learn More >>
                </a>
            </div>
        </div>
    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.2#fixes-compatible-with-prior-versions">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/PlatformOverview/Release%20Notes/Release%20Notes%207.2#bug-fixes">
                    Learn More >>
                </a>
            </div>
        </div>
...
In the current CloudMyDc Application Platform 7.2 release, the dashboard’s combo-boxes for environment selection were improved. For now, the displayed items provide better clarity by showing both the [custom alias](http://localhost:3000/docs/EnvironmentManagement/Environment%20Aliases) (if specified) and the environment name. Such implementation uniquely identifies the provided options and helps avoid possible confusion when several environments have similar aliases.
...
CloudMyDc Application Platform supports the most popular [operating system templates](http://localhost:3000/docs/Container/Container%20Image%20Requirements), which allows using multiple different solutions from Docker Hub as [custom containers](http://localhost:3000/docs/Container/Container%20Types). Due to the recent CentOS Linux 8 end of life, the recommended alternative template was added to the platform – **CentOS Stream 8**. You can find a [comparison of these two versions](https://centos.org/cl-vs-cs/) in the official documentation.
