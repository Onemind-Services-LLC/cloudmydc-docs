...
Configure any other desired customization (e.g. cloudlets limit, [public IP](https://cloudmydc.com/), [region](https://cloudmydc.com/), etc.) and click **Create**.
...
- **_Keep volumes data_** - saves data in [volumes](https://cloudmydc.com/)
