...
The more detailed information on available parameters can be found within the corresponding [API method](https://cloudmydc.com/) description and at the [CreateEnvironment API](https://cloudmydc.com/) overview.
...
The full list of the special Docker parameters can be found at the appropriate [document](https://cloudmydc.com/).
