...
- the [_Built-In SSL_](/docs/application-setting/ssl/built-in-ssl) option allows to automatically configure SSL for the base domain of the environment without public IP
