...
The platform provides [Session Replication](http://localhost:3000/docs/application-setting/scaling-and-clustering/session-replication-for-ha) between instances of web-servers with a help of multicast. But also you can use **Session Replication via Memcached**.
