...
- [Python Environment Hosting](https://cloudmydc.com/)
- [Python Versioning](https://cloudmydc.com/)
...
- Each instance is a fully independent [isolated container](https://cloudmydc.com/).
- Instances of the same layer are automatically distributed across available hosts ensuring [high availability](https://cloudmydc.com/).
...
You can select the required [version of Python](https://cloudmydc.com/) directly from the topology wizard during the creation of a new environment, as well as adjust it for already existing ones using [container redeployment](https://cloudmydc.com/).
...
Git flow provides a possibility of sequential or simultaneous deploy, as well as [automatic redeployment](https://cloudmydc.com/) from the repository if new code changes appear.
...
- [Django CMS](https://cloudmydc.com/)
- [Mezzanine CMS](https://cloudmydc.com/)
- [Wagtail CMS](https://cloudmydc.com/)
...
2. The management of the required software packages is commonly provided by [**_pip_**](https://cloudmydc.com/) - a popular Python package management system for the [PiPI](https://cloudmydc.com/) repository. Below, some of the most common commands are listed:
...
If needed, the default domain name of your Python application can be replaced with a [custom one](https://cloudmydc.com/) via:
...
- [MySQL Connection](https://cloudmydc.com/)
