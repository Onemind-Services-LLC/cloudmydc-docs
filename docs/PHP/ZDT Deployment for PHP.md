...
This can be clearly seen if entering your application server’s container [via SSH](https://cloudmydc.com/) and executing the long format file-listing command for your **webroot** folder, i.e.:
