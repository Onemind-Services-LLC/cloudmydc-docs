...
- The resources are provisioned with granular units - [cloudlets](/docs/platform-overview/cloudlet) (128MiB of RAM and 400MHz of CPU). This allows to allocate exactly the needed amount of resources.
...
- The system of _[automatic discounts](/docs/account-and-pricing/automatic-discounts)_ makes the platform usage even more beneficial when the volume of ordered resources grows.
...
- when calculating your cloudlet consumption, we only consider the larger of RAM or CPU usage per hour (i.e. not both combined). Learn more with the [Charged Resources](/docs/account-and-pricing/resource-charging/charged-resources) doc
...
- [Charged Resources](/docs/account-and-pricing/resource-charging/pricing-faq) - learn what is charged at the platform
