    ...
    <div style={{
        ...
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/docs/platform-overview/release-notes/release-notes-8.0.2#ssh-key-types-support">
                    Learn More >>
                </a>
            </div>
        </div>
    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/docs/platform-overview/release-notes/release-notes-8.0.2#extended-environment-metadata">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/docs/platform-overview/release-notes/release-notes-8.0.2#custom-data-in-cloud-scripting-response">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/docs/platform-overview/release-notes/release-notes-8.0.2#ssl-installation-error-description">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/docs/platform-overview/release-notes/release-notes-8.0.2#api-changes">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/docs/platform-overview/release-notes/release-notes-8.0.2#software-stack-versions">
                    Learn More >>
                </a>
            </div>
        </div>
    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/docs/platform-overview/release-notes/release-notes-8.0.2#fixes-compatible-with-prior-versions">
                    Learn More >>
                </a>
            </div>
        </div>
...
[More info](/docs/deployment-tools/ssh/generate-ssh-key)
