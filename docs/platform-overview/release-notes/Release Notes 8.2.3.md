...
In this document, you will find all of the new features, enhancements and visible changes included to the **CloudMyDc PaaS 8.2.3** release.
    ...
    <div style={{
        ...
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/docs/PlatformOverview/Release%20Notes/Release%20Notes%208.2.3#software-stack-versions">
                    Learn More >>
                </a>
            </div>
        </div>
    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/docs/PlatformOverview/Release%20Notes/Release%20Notes%208.2.3#fixes-compatible-with-prior-versions">
                    Learn More >>
                </a>
            </div>
        </div>
...
Below, you can find the fixes that were implemented in the CloudMyDc Application Platform 8.2.3 release and also integrated into previous platform versions by means of the appropriate patches.
