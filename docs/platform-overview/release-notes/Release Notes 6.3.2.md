    ...
    <div style={{
        ...
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/platform-overview/release-notes/release-notes-6.3.2#software-stack-versions">
                    Learn More >>
                </a>
            </div>
        </div>
    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/platform-overview/release-notes/release-notes-6.3.2#fixes-compatible-with-prior-versions">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="/platform-overview/release-notes/release-notes-6.3.2#bug-fixes">
                    Learn More >>
                </a>
            </div>
        </div>
