...
slug: release-notes-6.3.2
sidebar_position: 17
---

import obj from './ReleaseNotes6.3.2.json'

## CloudMyDc Application Platform 6.3.2
    ...
    <div style={{
        ...
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/platform-overview/release-notes/release-notes-6.3.2#software-stack-versions">
                    Learn More >>
                </a>
            </div>
        </div>
    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/platform-overview/release-notes/release-notes-6.3.2#fixes-compatible-with-prior-versions">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/platform-overview/release-notes/release-notes-6.3.2#bug-fixes">
                    Learn More >>
                </a>
            </div>
        </div>
