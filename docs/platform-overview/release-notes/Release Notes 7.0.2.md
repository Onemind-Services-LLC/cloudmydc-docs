...
slug: release-notes-7.0.2
sidebar_position: 15
---

import obj from './ReleaseNotes7.0.2.json'

## CloudMyDc Application Platform 7.0.2

_This document is preliminary and subject to change._

In this document, you will find all of the new features, enhancements and visible changes included to the **CloudMyDc PaaS 7.0.2** release.
    ...
    <div style={{
        ...
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/platform-overview/release-notes/release-notes-7.0.2#software-stack-versions">
                    Learn More >>
                </a>
            </div>
        </div>
    ...
    <div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/platform-overview/release-notes/release-notes-7.0.2#fixes-compatible-with-prior-versions">
                    Learn More >>
                </a>
            </div>
        </div>
        <div style={{
            ...
            flexDirection: 'row-reverse',
                ...
                <a href="http://localhost:3000/docs/platform-overview/release-notes/release-notes-7.0.2#bug-fixes">
                    Learn More >>
                </a>
            </div>
        </div>
