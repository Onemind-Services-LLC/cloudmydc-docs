...
You can use an [endpoint](https://cloudmydc.com/) or [public IP](https://cloudmydc.com/) as your database entry point for external connection. Let’s check the endpoint example (to the Pgpool-II node for the cluster):
